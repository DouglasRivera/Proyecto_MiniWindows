 ...
 * @author famii
 */
public class NavegadorTree extends javax.swing.JFrame {

    /**
     * Creates new form NavegadorTree
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NavegadorTree.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NavegadorTree().setVisible(true);
            }
        });
    }
